...
TEST_F(UnitLoadingTest, AngleDegreeReadTest) {
    value = cqsp::common::loading::ReadUnit("135deg", UnitType::Angle, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, cqsp::common::components::types::toRadian(135));
}

TEST_F(UnitLoadingTest, AllLetterReadTest) {
    value = cqsp::common::loading::ReadUnit("asdoi", UnitType::Angle, &correct);
    EXPECT_FALSE(correct);
    value = cqsp::common::loading::ReadUnit("asd oi", UnitType::Angle, &correct);
    EXPECT_FALSE(correct);
    value = cqsp::common::loading::ReadUnit("asd oi ", UnitType::Angle, &correct);
    EXPECT_FALSE(correct);
    value = cqsp::common::loading::ReadUnit(" asd oi ", UnitType::Angle, &correct);
...
TEST_F(UnitLoadingTest, AngleDegreeWithSpaceReadTest) {
    value = cqsp::common::loading::ReadUnit("135 deg", UnitType::Angle, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, cqsp::common::components::types::toRadian(135));
}

TEST_F(UnitLoadingTest, AngleDegreeWithUnitlessReadTest) {
    value = cqsp::common::loading::ReadUnit("135", UnitType::Angle, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, cqsp::common::components::types::toRadian(135));
}
...
TEST_F(UnitLoadingTest, AngleRadianWithSpaceReadTest) {
    value = cqsp::common::loading::ReadUnit("15 rad", UnitType::Angle, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, 15);
}

TEST_F(UnitLoadingTest, AngleRadianWithSpaceExponentReadTest) {
    value = cqsp::common::loading::ReadUnit("15e5 rad", UnitType::Angle, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, 15e5);
}

TEST_F(UnitLoadingTest, AngleWithGarbagetReadTest) {
    value = cqsp::common::loading::ReadUnit("15e5 49", UnitType::Angle, &correct);
    EXPECT_FALSE(correct);
}

TEST_F(UnitLoadingTest, DistanceTest) {
    value = cqsp::common::loading::ReadUnit("15e5km", UnitType::Distance, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, 15e5);

    value = cqsp::common::loading::ReadUnit("5AU", UnitType::Distance, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, cqsp::common::components::types::toKm(5));
}

TEST_F(UnitLoadingTest, MassTest) {
    value = cqsp::common::loading::ReadUnit("15e5kg", UnitType::Mass, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, 15e5);

    value = cqsp::common::loading::ReadUnit("5t", UnitType::Mass, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, 5000);

    value = cqsp::common::loading::ReadUnit("5g", UnitType::Mass, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, 0.005);
}

TEST_F(UnitLoadingTest, VolumeTest) {
    value = cqsp::common::loading::ReadUnit("15e5m3", UnitType::Volume, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, 15e5);
}
...
TEST_F(UnitLoadingTest, NegativeTestChanges) {
    value = cqsp::common::loading::ReadUnit("-45000 m", UnitType::Distance, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, -45);
}

TEST_F(UnitLoadingTest, MinuteTesting) {
    value = cqsp::common::loading::ReadUnit("10 m", UnitType::Time, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, 10 * 60);
}

TEST_F(UnitLoadingTest, HourTesting) {
    value = cqsp::common::loading::ReadUnit("10 h", UnitType::Time, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, 10 * 60 * 60);
}

TEST_F(UnitLoadingTest, DayTesting) {
    value = cqsp::common::loading::ReadUnit("10 d", UnitType::Time, &correct);
    EXPECT_TRUE(correct);
    EXPECT_DOUBLE_EQ(value, 10 * 60 * 60 * 24);
}

TEST_F(UnitLoadingTest, SecondTesting) {
    value = cqsp::common::loading::ReadUnit("10 s", UnitType::Time, &correct);
    EXPECT_TRUE(correct);
