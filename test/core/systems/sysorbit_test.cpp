...
#include "core/systems/sysorbit_test.h"
...
TEST_F(SysOrbitTest, BasicOrbitTest) {
    ...
    auto& body_component = universe.get<cqsp::core::components::bodies::Body>(earth);

    entt::entity ship1 = cqsp::core::actions::LaunchShip(
        game.GetUniverse(),
        cqsp::core::components::types::Orbit(body_component.radius + 500., 0.00001, 0, 0.01, 0.1, 0, earth));
...
class PlaneMatchTests
    : public SysOrbitTest,
      public testing::WithParamInterface<
          std::tuple<cqsp::core::components::types::Orbit, cqsp::core::components::types::Orbit, double>> {
};  // Chaser orbit, target orbit, and precision

INSTANTIATE_TEST_SUITE_P(
    PlaneMatchingTests, PlaneMatchTests,
    testing::Values(std::tuple(cqsp::core::components::types::Orbit(6371 + 500., 0.00001, 0, 0, 0.1, 0),
                               cqsp::core::components::types::Orbit(6371 + 500., 0.00001, 0.2, 0.8, 0.1, 0), 0.0001),
                    std::tuple(cqsp::core::components::types::Orbit(10000, 0.00001, 0, 0, 0.1, 0),
                               cqsp::core::components::types::Orbit(10000, 0.00001, 0.2, 0.8, 0.1, 0), 0.0001),
                    std::tuple(cqsp::core::components::types::Orbit(50000, 0.00001, 0, 0, 0.1, 0),
                               cqsp::core::components::types::Orbit(50000, 0.00001, 0.2, 0.8, 0.1, 0), 0.0001),
                    std::tuple(cqsp::core::components::types::Orbit(50000, 0.00001, 0, 0, 0.1, 0),
                               cqsp::core::components::types::Orbit(50000, 0.00001, 0.5, 1.5, 0.1, 0), 0.0001),
                    std::tuple(cqsp::core::components::types::Orbit(50000, 0.00001, 0, 0, 0.1, 0),
                               cqsp::core::components::types::Orbit(50000, 0.00001, 4.5, 0.8, 0.1, 0), 0.0001),
                    std::tuple(cqsp::core::components::types::Orbit(50000, 0.00001, 0.2, 0, 0.1, 0),
                               cqsp::core::components::types::Orbit(50000, 0.00001, 0, 0.8, 0.1, 0), 0.0001),
                    std::tuple(cqsp::core::components::types::Orbit(50000, 0.00001, 0.2, 0.8, 0.1, 0),
                               cqsp::core::components::types::Orbit(50000, 0.00001, 0, 0.8, 0.1, 0), 0.0001),
                    std::tuple(cqsp::core::components::types::Orbit(50000, 0.00001, 0.2, 0.8, 0.1, 0),
                               cqsp::core::components::types::Orbit(50000, 0.00001, 0, 0.8, 0.1, 0), 0.0001),
                    std::tuple(cqsp::core::components::types::Orbit(50000, 0.00001, 0.2, 0.8, 0.1, 0),
                               cqsp::core::components::types::Orbit(50000, 0.00001, 5.4, 5.8, 0.1, 0), 0.0001),
                    std::tuple(cqsp::core::components::types::Orbit(50000, 0.00001, 5.4, 5.8, 0.1, 0),
                               cqsp::core::components::types::Orbit(50000, 0.00001, 0.2, 0.8, 0.1, 0), 0.0001),
                    std::tuple(cqsp::core::components::types::Orbit(25000, 0.00001, 5.4, 5.8, 0.1, 0),
                               cqsp::core::components::types::Orbit(50000, 0.00001, 0.2, 0.8, 0.1, 0), 0.0001),
                    std::tuple(cqsp::core::components::types::Orbit(7000, 0.00001, 5.4, 5.8, 0.1, 1.3),
                               cqsp::core::components::types::Orbit(380000, 0.4, 0.2, 0.8, 0.1, 0),
                               0.001)));  // This one is not as precise as before, but still is reasonably precise

TEST_P(PlaneMatchTests, MatchPlaneTest) {
    auto& earth_body_component = universe.get<cqsp::core::components::bodies::Body>(earth);
    // Chaser ship
    cqsp::core::components::types::Orbit source_orbit = std::get<0>(GetParam());
    source_orbit.GM = earth_body_component.GM;
    source_orbit.reference_body = earth;
    entt::entity ship1 = cqsp::core::actions::LaunchShip(game.GetUniverse(), source_orbit);

    cqsp::core::components::types::Orbit target_orbit = std::get<1>(GetParam());
    target_orbit.GM = earth_body_component.GM;
    target_orbit.reference_body = earth;
    // Target ship
    entt::entity ship2 = cqsp::core::actions::LaunchShip(game.GetUniverse(), target_orbit);

    cqsp::core::components::Maneuver_t maneuver = cqsp::core::systems::MatchPlanes(source_orbit, target_orbit);
    cqsp::core::systems::commands::PushManeuver(universe, ship1, maneuver);
    ASSERT_TRUE(universe.all_of<cqsp::core::components::CommandQueue>(ship1));

    auto& ship1_orbit = universe.get<cqsp::core::components::types::Orbit>(ship1);
    auto& ship2_orbit = universe.get<cqsp::core::components::types::Orbit>(ship2);
    ...
    SPDLOG_INFO("Chaser orbit position: {}", glm::to_string(cqsp::core::components::types::toVec3(ship1_orbit)));
    SPDLOG_INFO("Target orbit position: {}", glm::to_string(cqsp::core::components::types::toVec3(ship2_orbit)));

    SPDLOG_INFO("Chaser orbit velocity: {}",
                glm::to_string(cqsp::core::components::types::OrbitVelocityToVec3(ship1_orbit)));
    SPDLOG_INFO("Target orbit velocity: {}",
                glm::to_string(cqsp::core::components::types::OrbitVelocityToVec3(ship2_orbit)));
    auto& queue = universe.get<cqsp::core::components::CommandQueue>(ship1);
...
class CircularizeTests : public SysOrbitTest, public testing::WithParamInterface<cqsp::core::components::types::Orbit> {
 protected:
    void ExpectNoPlaneChange(entt::entity ship) {
        ...
        ASSERT_FALSE(universe.any_of<cqsp::core::components::ships::Crash>(ship));
    ...
    void AddManeuver(cqsp::core::components::Maneuver_t circularize, entt::entity ship) {
        cqsp::core::systems::commands::PushManeuver(universe, ship, circularize);
        ASSERT_TRUE(universe.all_of<cqsp::core::components::CommandQueue>(ship));
        TickSeconds(circularize.second + 1.);

        auto& queue = universe.get<cqsp::core::components::CommandQueue>(ship);
        EXPECT_TRUE(queue.maneuvers.empty());
    }

    cqsp::core::components::types::Orbit GetSourceOrbit() {
        auto& earth_body_component = universe.get<cqsp::core::components::bodies::Body>(earth);
        // Chaser ship
        cqsp::core::components::types::Orbit source_orbit = GetParam();
        source_orbit.GM = earth_body_component.GM;
...
TEST_P(CircularizeTests, ChangeApoapsis) {
    cqsp::core::components::types::Orbit source_orbit = GetSourceOrbit();
    entt::entity ship = cqsp::core::actions::LaunchShip(universe, source_orbit);

    auto& ship_orbit = universe.get<cqsp::core::components::types::Orbit>(ship);
    Tick(1);
    cqsp::core::components::Maneuver_t circularize = cqsp::core::systems::CircularizeAtApoapsis(ship_orbit);
    cqsp::core::systems::commands::PushManeuver(universe, ship, circularize);
    ASSERT_TRUE(universe.all_of<cqsp::core::components::CommandQueue>(ship));
    ...
    EXPECT_NEAR(ship_orbit.OrbitalVelocityAtTrueAnomaly(0),
                glm::length(circularize.first) +
                    source_orbit.OrbitalVelocityAtTrueAnomaly(cqsp::core::components::types::apoapsis),
                2);

    EXPECT_NEAR(ship_orbit.OrbitalVelocityAtTrueAnomaly(0),
                cqsp::core::components::types::GetCircularOrbitingVelocity(ship_orbit.GM, ship_orbit.semi_major_axis),
                1);
...
TEST_P(CircularizeTests, ChangePeriapsis) {
    ...
    cqsp::core::components::Maneuver_t circularize = cqsp::core::systems::CircularizeAtPeriapsis(ship_orbit);
    cqsp::core::systems::commands::PushManeuver(universe, ship, circularize);
    ASSERT_TRUE(universe.all_of<cqsp::core::components::CommandQueue>(ship));
    ...
    // This can be more inaccurate because we are sourcing these values from many different calculations, so we
    // must allow for some numerical inaccuricies
    EXPECT_NEAR(ship_orbit.OrbitalVelocityAtTrueAnomaly(cqsp::core::components::types::apoapsis),
...
INSTANTIATE_TEST_SUITE_P(BasicCircularizeTest, CircularizeTests,
                         testing::Values(cqsp::core::components::types::Orbit(10000., 0.2, 0, 0, 0.1, 0),
                                         cqsp::core::components::types::Orbit(10000., 0.3, 0.3, 0, 0.1, 0),
                                         cqsp::core::components::types::Orbit(10000., 0.3, 0.1, 0.3, 0.1, 0),
                                         cqsp::core::components::types::Orbit(10000., 0.3, 0.1, 0.3, 0.1, 1.2),
                                         cqsp::core::components::types::Orbit(20000., 0.6, 0.1, 0.3, 0.1, 1.2),
                                         cqsp::core::components::types::Orbit(50000, 0.2, 2.4, 5.8, 0.1, 1)));

TEST_F(SysOrbitTest, BasicTransferToMoonTest) {
    auto& earth_body_component = universe.get<cqsp::core::components::bodies::Body>(earth);
    // Chaser ship
    cqsp::core::components::types::Orbit source_orbit =
        cqsp::core::components::types::Orbit(50000, 0.00001, 5.4, 5.8, 0.1, 0);
    source_orbit.GM = earth_body_component.GM;
    source_orbit.reference_body = earth;
    entt::entity ship = cqsp::core::actions::LaunchShip(universe, source_orbit);
    Tick(1);
    cqsp::core::systems::commands::TransferToMoon(universe, ship, moon);
    ...
    auto& ship_orbit = universe.get<cqsp::core::components::types::Orbit>(ship);
    auto& moon_orbit = universe.get<cqsp::core::components::types::Orbit>(moon);
...
TEST_F(SysOrbitTest, DISABLED_EccentricTransferToMoonTest) {
    ...
    // Chaser ship
    cqsp::core::components::types::Orbit source_orbit =
        cqsp::core::components::types::Orbit(50000, 0.2, 2.4, 5.8, 0.1, 1.2);
    source_orbit.GM = earth_body_component.GM;
    source_orbit.reference_body = earth;
    entt::entity ship = cqsp::core::actions::LaunchShip(universe, source_orbit);
    Tick(1);
...
TEST_F(SysOrbitTest, ManeuverTest) {
    ...
    source_orbit.GM = earth_body_component.GM;
    source_orbit.reference_body = earth;
    const entt::entity ship = cqsp::core::actions::LaunchShip(universe, source_orbit);

    // Let's just add prograde maneuvers everywhere and see if we see the intended velocity changes
    const auto maneuver = cqsp::core::systems::commands::MakeManeuver(glm::dvec3(0, 2, 0), 1000);
    cqsp::core::systems::commands::PushManeuver(universe, ship, maneuver);

    const auto& ship_orbit = universe.get<cqsp::core::components::types::Orbit>(ship);

    // Let's get the expected speed at the true anomaly
    const double true_anomaly = cqsp::core::components::types::GetTrueAnomaly(ship_orbit, maneuver.second);
    // Now get our value
