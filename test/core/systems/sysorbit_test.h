...
class ManeuverTestSimulation : public cqsp::core::systems::simulation::Simulation {
 public:
    explicit ManeuverTestSimulation(cqsp::core::Game& game) : cqsp::core::systems::simulation::Simulation(game) {}

    void CreateSystems() override { AddSystem<cqsp::core::systems::SysOrbit>(); }
};
...
struct SysOrbitTest : public ::testing::Test {
 protected:
    ...
    static void SetUpTestSuite() {
        std::filesystem::path data_path(cqsp::core::util::GetCqspTestDataPath());
    ...
    void SetUp() override {
        ...
        // into the
        cqsp::core::loading::PlanetLoader loader(game.GetUniverse());
    ...
    testing::AssertionResult IsSamePlane(entt::entity ship1, entt::entity ship2, double tolerance = 0.00001) {
        auto& kinematics1 = universe.get<cqsp::core::components::types::Kinematics>(ship1);
        auto& kinematics2 = universe.get<cqsp::core::components::types::Kinematics>(ship2);
