...
/**
  ...
  * solutions
  */
const std::vector<glm::dvec3> &lambert_problem::get_v1() const { return m_v1; }
...
/**
  ...
  * solutions
  */
const std::vector<glm::dvec3> &lambert_problem::get_v2() const { return m_v2; }
...
/**
  ...
  */
const std::vector<int> &lambert_problem::get_iters() const { return m_iters; }
