...
// Adds modifier_entity's effect to target_entity and recalculates the affected ModifiableValue.
void ApplyModifier(Universe& universe, entt::entity modifier_entity, entt::entity target_entity);

// Removes modifier_entity's effect from target_entity and recalculates the affected ModifiableValue.
